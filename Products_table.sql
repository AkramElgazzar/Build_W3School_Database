...
------------------------------------------------------------------------------------------------------
-- rename UnitPrice column to unit and change datatype

ALTER TABLE products ALTER COLUMN unitprice NVARCHAR(30) NOT NULL;
EXEC sp_rename 'products.unitprice', 'unit', 'COLUMN';
